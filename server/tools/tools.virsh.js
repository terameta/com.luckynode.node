...
function getMostAvailablePool(){
	...
	tools.runLocalCommand('virsh pool-list --details').then(function(result){
		...
		result.forEach(function(curPoolDetails){
			...
			if(curPool[9] == 'MiB') 	curSize = curSize * 1048576;
			if(curPool[9] == 'G') 		curSize = curSize * 1000000000;
			if(curPool[9] == 'GB') 		curSize = curSize * 1000000000;
			if(curPool[9] == 'GiB') 	curSize = curSize * 1073741824;
			if(curPool[9] == 'T') 		curSize = curSize * 1000000000000;
			if(curPool[9] == 'TB') 		curSize = curSize * 1000000000000;
			if(curPool[9] == 'TiB') 	curSize = curSize * 1099511627776;
			if(curPool[9] == 'P') 		curSize = curSize * 1000000000000000;
			if(curPool[9] == 'PB') 		curSize = curSize * 1000000000000000;
			if(curPool[9] == 'PiB') 	curSize = curSize * 1125899906842624;
			if(curPool[9] == 'E') 		curSize = curSize * 1000000000000000000;
			if(curPool[9] == 'EB') 		curSize = curSize * 1000000000000000000;
			if(curPool[9] == 'EiB') 	curSize = curSize * 1152921504606846976;
			console.log(curSize);
